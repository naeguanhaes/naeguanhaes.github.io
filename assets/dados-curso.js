  ...
  cursos: [
    ...
    /* ═══════════════ DIREITO ═══════════════ */
    {
      ...
      atividades: {
        ...
        tabela: [
          { grupo: 'Ensino', atividade: 'Aprovação em disciplina cursada em curso de Direito, não utilizada para dispensa ou aproveitamento de curso', porEvento: '30 h por disciplina', teto: 30, desdeQuando: 'Vale também disciplina anterior à matrícula: quem é egresso de curso de Direito ou veio por transferência pode protocolar o histórico escolar com o plano de ensino de anos anteriores.', comprovante: 'Histórico escolar com o plano de ensino da disciplina' },
          { grupo: 'Ensino', atividade: 'Aprovação em disciplina cursada em outro curso de graduação, não utilizada como eletiva', porEvento: '30 h por disciplina', teto: 30, desdeQuando: 'Vale também disciplina anterior à matrícula na graduação, desde que tenha correlação inter ou transdisciplinar com o Curso de Direito da UEMG Guanhães.', comprovante: 'Histórico escolar com o plano de ensino da disciplina' },
          ...
          { grupo: 'Ensino', atividade: 'Realização de estágio profissional extracurricular', porEvento: '30 h por semestre', teto: 90, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade. Contempla quem dispensou as disciplinas de prática real por já ter cumprido horas em área jurídica compatível com o NPJ, e contempla também estágio em área diversa do Direito.', comprovante: 'Declaração do supervisor de estágio, com avaliação, período de realização, data de início e de término' },
          { grupo: 'Ensino', atividade: 'Participação em sessão pública de defesa de monografia ou trabalho de conclusão de curso de graduação', porEvento: '1 h por defesa', teto: 30, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade. Se a defesa for nesta unidade, apresente-se na secretaria antes dela para retirar o formulário da declaração e avise o presidente da banca sobre a assinatura.', comprovante: 'Declaração de participação como ouvinte, assinada pelo orientador do trabalho (Formulário 1)' },
          { grupo: 'Ensino', atividade: 'Participação em sessão pública de defesa de mestrado ou doutorado', porEvento: '2 h por defesa', teto: 30, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Declaração de participação como ouvinte, assinada pelo orientador do trabalho (Formulário 1)' },
          { grupo: 'Ensino', atividade: 'Participação em audiência e em sessões de julgamento perante o Poder Judiciário, não contabilizadas para o estágio obrigatório', porEvento: '2 h por audiência', teto: 30, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Declaração de participação como ouvinte, assinada pelo servidor público responsável (Formulário 2)' },
          { grupo: 'Ensino', atividade: 'Participação em audiência em órgãos públicos', porEvento: '2 h por audiência', teto: 30, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Declaração de participação como ouvinte, assinada pelo setor responsável (Formulário 3)' },
          ...
          { grupo: 'Ensino', atividade: 'Participação em programa de intercâmbio ou mobilidade acadêmica reconhecido pela UEMG', porEvento: '30 h por semestre', teto: 60, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração de participação' },
          { grupo: 'Ensino', atividade: 'Realização de curso de informática, língua portuguesa, línguas estrangeiras e afins', porEvento: '15 h por semestre', teto: 60, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração de participação' },

          { grupo: 'Extensão', atividade: 'Participação em projeto de extensão desenvolvido no âmbito da UEMG', porEvento: '15 h por semestre', teto: 90, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração do coordenador do grupo ou de outro órgão competente' },
          { grupo: 'Extensão', atividade: 'Participação em projeto de extensão desenvolvido no âmbito de outras instituições de ensino superior', porEvento: '10 h por semestre', teto: 30, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração do coordenador do grupo ou de outro órgão competente' },
          { grupo: 'Extensão', atividade: 'Participação formal em órgãos de representação estudantil, colegiado de curso, outras estruturas formais de integração do corpo discente ou representação de turma', porEvento: '15 h por semestre', teto: 90, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração da Direção da Unidade' },
          { grupo: 'Extensão', atividade: 'Participação em comissão organizadora de evento de extensão desenvolvido no âmbito da UEMG', porEvento: '15 h por evento organizado', teto: 60, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração de participação' },
          ...
          { grupo: 'Extensão', atividade: 'Participação em eventos como congressos, jornadas, simpósios, encontros, aulas inaugurais, palestras, fóruns e atividades artísticas promovidos pela UEMG, por outras instituições de ensino superior ou por organizações juridicamente relevantes', porEvento: '30 h por semestre', teto: 90, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade. Os Seminários de Direito e Literatura já realizados neste curso podem ser contados aqui, por terem sido um ciclo aberto a todos os períodos e de grande divulgação regional.', comprovante: 'Certificado de participação' },

          { grupo: 'Pesquisa', atividade: 'Participação em grupo de pesquisa regularmente inscrito no Diretório dos Grupos de Pesquisa do CNPq', porEvento: '15 h por semestre', teto: 90, desdeQuando: 'Somente a partir da data da sua matrícula no curso de Direito desta unidade.', comprovante: 'Certificado ou declaração do coordenador do grupo' },
          { grupo: 'Pesquisa', atividade: 'Publicação de livro de caráter científico com registro no ISBN', porEvento: '30 h por obra', teto: 30, desdeQuando: 'Somente livro publicado a partir da data da sua matrícula e com pertinência para as ciências jurídicas.', comprovante: 'Cópia da ficha catalográfica da obra' },
          { grupo: 'Pesquisa', atividade: 'Publicação de artigo científico em periódico indexado no Qualis/CAPES, em anais de evento nacional ou internacional, ou capítulo de livro em obra com ISBN', porEvento: '15 h por artigo ou capítulo publicado', teto: 60, desdeQuando: 'Somente publicação a partir da data da sua matrícula e com pertinência para as ciências jurídicas. Para comprovar, serve a cópia do artigo com o comprovante de submissão ao periódico; no caso de capítulo, a cópia e o comprovante de aceite em obra que terá ISBN.', comprovante: 'Cópia da ficha catalográfica do periódico e da publicação realizada' },
          { grupo: 'Pesquisa', atividade: 'Publicação de resumo ou resumo expandido em anais de evento nacional ou internacional, ou em obra coletiva com ISBN decorrente do evento', porEvento: '5 h por resumo publicado', teto: 30, desdeQuando: 'Somente publicação a partir da data da sua matrícula e com pertinência para as ciências jurídicas.', comprovante: 'Cópia da ficha catalográfica dos anais do evento e da publicação realizada' },
          { grupo: 'Pesquisa', atividade: 'Apresentação de trabalho em evento nacional ou internacional', porEvento: '3 h por apresentação', teto: 15, desdeQuando: 'Somente apresentação a partir da data da sua matrícula e com pertinência para as ciências jurídicas.', comprovante: 'Certificado ou declaração de participação' },
